...
(function ($) {
  ...
  function Event() {
    var handlers = [];
		 ...
		 * <p>
		 * Event handler will receive two arguments - an <code>EventData</code> and the <code>data</code> object the event was fired with.
		 * <p>
		 * 
		 * @method subscribe
		 * @param fn
    ...
    this.unsubscribe = function (fn) {
      for (var i = handlers.length - 1; i >= 0; i--) {
		 ...
		 * @param e
		 *            {EventData} Optional. An <code>EventData</code> object to be passed to all handlers. For DOM events, an existing W3C/jQuery
		 *            event object can be passed in.
		 * @param scope
  ...
  Group.prototype.equals = function (group) {
	 ...
	 * store arbitrary data in it. That data can later be accessed by group totals formatters during the display.
	 * 
	 * @class GroupTotals
	 * @extends Slick.NonDataItem
	 * @constructor
  ...
  GroupTotals.prototype = new NonDataItem();
	 ...
	 * class of state and validation synchronization issues. An edit controller (such as SlickGrid) can query if an active edit is in progress and
	 * attempt a commit or cancel before proceeding.
	 * 
	 * @class EditorLock
	 * @constructor
	 */
  function EditorLock() {
    ...
    this.deactivate = function (editController) {
      ...
      activeEditController = null;
		 ...
		 * attempt was successful (commit may fail due to validation errors, etc.). Edit controller's "commitCurrentEdit" must return true if the
		 * commit has succeeded and false otherwise. If no edit controller is active, returns true.
		 * 
    ...
    this.commitCurrentEdit = function () {
      return (activeEditController ? activeEditController.commitCurrentEdit() : true);
		 ...
		 * successfully cancelled. If no edit controller is active, returns true.
		 * 
