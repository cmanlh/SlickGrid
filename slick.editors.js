...
(function($) {
	...
	function TextEditor(args) {
		...
		this.init = function() {
			$input = $("<INPUT type=text class='editor-text' />").appendTo(args.container).on("keydown.nav", function(e) {
	...
	/*
	 * An example of a "detached" editor. The UI is added onto document BODY and .position(), .show() and .hide() are implemented. KeyDown events are
	 * also handled to provide handling for Tab, Shift-Tab, Esc and Ctrl-Enter.
	 */
